            ...
            <div class="grid gap-6">
                ...
                <div class="space-y-2">
                    <x-label for="case_number" class="text-base-content">
                        Case or Reference Number <span class="text-primary/70">(optional)</span>
                    </x-label>
                    <input
                        id="case_number"
                        type="text"
        ...
        @else
            <div class="space-y-6">
                ...
                <div class="alert alert-info shadow-lg">
                    ...
                    <span>Additional details help us better assist you with your case. However, you can skip these steps if you prefer.</span>
                </div>
