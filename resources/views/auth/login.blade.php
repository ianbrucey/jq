...
{{--                <img src="{{ asset('images/JQ.png') }}" class="h-10 lg:h-14 mb-6 mx-auto lg:mx-0" alt="Justice Quest Logo" height="250" width="250">--}}

                <img src="{{ asset('images/blacklawyer.png') }}" class="hidden lg:block h-48 lg:h-64 mb-6  lg:mx-0 mx-auto" alt="Lawyer Image" >
                <img src="{{ asset('images/JQ.png') }}" class="lg:block h-20 lg:h-32 mb-6 mx-auto lg:mx-0 mx-auto" alt="Justice Quest Logo" >
